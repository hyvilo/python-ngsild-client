...
If you find a security vulnerability in Python NGSI-LD Client, please report it through [GitHub's private vulnerability reporting](https://github.com/hyvilo-it-admin/python-ngsild-client/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact it-admin@hyvilo.eu for details.
