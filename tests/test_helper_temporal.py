...
def test_build_temporal_query_before():
    dt = datetime(2022, 9, 23, 12, 0, 0, tzinfo=UTC)
...
def test_build_temporal_query_after():
    dt = datetime(2022, 8, 23, 12, 0, 0, tzinfo=UTC)
...
def test_build_temporal_query_between():
    dt1 = datetime(2022, 8, 23, 12, 0, 0, tzinfo=UTC)
    dt2 = datetime(2022, 9, 23, 12, 0, 0, tzinfo=UTC)
