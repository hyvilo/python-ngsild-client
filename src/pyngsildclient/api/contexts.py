...
from pyngsildclient.model.constants import CORE_CONTEXT
...
class Contexts:
    ...
    def list(self, pattern: str | None = None) -> dict | None:
    ...
    @rfc7807_error_handle
    def delete(self, ctx: str, pattern: str | None = None) -> bool:
        if pattern is None:
