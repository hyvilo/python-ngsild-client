...
from pyngsildclient.utils.console import Console
...
class Client:
    ...
    def create(self, *entities) -> bool | BatchResult:
    ...
    def delete(self, *entities) -> bool | BatchResult:
    ...
    def delete_from_file(self, filename: str) -> bool | BatchResult:
    ...
    def upsert(self, *entities, update: bool = False) -> bool | BatchResult:
    ...
    def bulk_import(self, filename: str) -> bool | dict:
    ...
    def update(self, *entities, overwrite=True) -> bool | BatchResult:
        """Upsert one or many entities.
    ...
    def _broker_version_orionld(self) -> str | None:
    ...
    def _broker_version_java_spring(self) -> tuple[Vendor, str] | None:
