...
class AsyncClient:
    ...
    def __init__(
        ...
        proxy: str | None = None,
        custom_auth: AuthTypes | None = None,
    ):
        ...
        self.client = httpx.AsyncClient(auth=custom_auth, headers=headers, proxy=self.proxy)
    ...
    async def create(self, *entities) -> bool | BatchResult:
    ...
    async def delete(self, *entities) -> bool | BatchResult:
    ...
    async def delete_from_file(self, filename: str) -> bool | dict:
    ...
    async def upsert(self, *entities, update: bool = False) -> bool | BatchResult:
    ...
    async def bulk_import(self, filename: str) -> bool | dict:
    ...
    async def update(self, *entities, overwrite=True) -> bool | BatchResult:
        """Upsert one or many entities.
    ...
    async def count(self, type: str | None = None, q: str | None = None, gq: str | None = None) -> int:
    ...
    async def delete_where(self, type: str | None = None, q: str | None = None, **kwargs):
